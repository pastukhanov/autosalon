...
public class Forms {
    ...
    public JDialog getCarForm(Long id, CarType carType, String model, String brand, boolean isEditMode) {
        ...
        JComboBox<CarType> carTypeComboBox = addField(addCarDialog, "Car Type:", new JComboBox<>(CarType.values()), comboBox -> {
            if (carType != null) {
    ...
    private void saveCar(Long id, JComboBox<CarType> carTypeComboBox, String model, String brand, boolean isEditMode) {
    ...
    public JDialog getAddCustomerForm(Long id, String name, Integer age, CustomerGender gender, boolean isEditMode) {
        ...
        JTextField nameField = addField(addCustomerDialog, "Name:", new JTextField(name != null ? name : ""));
        JTextField ageField = addField(addCustomerDialog, "Age:", new JTextField(age != null ? age.toString() : ""));
    ...
    private void saveCustomer(Long id, String name, String ageString, String genderString, boolean isEditMode) {
        try {
            int age = Integer.parseInt(ageString);
            CustomerGender gender = genderString.toLowerCase().startsWith("m") ? CustomerGender.MALE : CustomerGender.FEMALE;
    ...
    private JScrollPane setupCarSearchField(JTextField searchField, DefaultListModel<Car> listModel, JTextField... carFields) {
    ...
    private void addSaleButtonAndActions(JDialog dialog, JTextField nameField, JTextField ageField, JComboBox<String> genderComboBox, JTextField carIdField) {
        JButton addSaleButton = new JButton("Add Sale");
        addSaleButton.addActionListener(e -> handleAddSaleAction(dialog, nameField, ageField, genderComboBox, carIdField));
    ...
    private void handleAddSaleAction(JDialog dialog, JTextField nameField, JTextField ageField, JComboBox<String> genderComboBox, JTextField carIdField) {
        try {
    ...
    private Customer createCustomerFromFields(JTextField nameField, JTextField ageField, JComboBox<String> genderComboBox) {
